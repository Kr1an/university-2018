...
namespace ISM.GOST3410
{
    ...
    class Program
    {
        ...
        {
            var crypt = new GOST3410Crypto();
            GOST3410Crypto.CECPoint publicKey;
            var sign = crypt.GenerateElectronicDigitalSignature("hello world", out publicKey);
            if (crypt.IsValidElectronicDigitalSignature("hello world", sign, publicKey)) {
